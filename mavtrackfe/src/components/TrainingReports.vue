...
export default {
  ...
  methods: {
    ...
    completeTask(schedule) {
      ...
      schedule.forEach(function (schedule) {
        if (schedule.is_complete_sunday) completes.add(schedule.sunday_workout);
        if (schedule.is_complete_monday) completes.add(schedule.monday_workout);
        if (schedule.is_complete_tuesday) completes.add(schedule.tuesday_workout);
        if (schedule.is_complete_wednesday) completes.add(schedule.wednesday_workout);
        if (schedule.is_complete_thursday) completes.add(schedule.thursday_workout);
        if (schedule.is_complete_friday) completes.add(schedule.friday_workout);
        if (schedule.is_complete_saturday) completes.add(schedule.saturday_workout);
      });
    ...
    notCompleteTask(schedule) {
      ...
      schedule.forEach(function (schedule) {
        if (!schedule.is_complete_sunday) notCompletes.add(schedule.sunday_workout);
        if (!schedule.is_complete_monday) notCompletes.add(schedule.monday_workout);
        if (!schedule.is_complete_tuesday) notCompletes.add(schedule.tuesday_workout);
        if (!schedule.is_complete_wednesday) notCompletes.add(schedule.wednesday_workout);
        if (!schedule.is_complete_thursday) notCompletes.add(schedule.thursday_workout);
        if (!schedule.is_complete_friday) notCompletes.add(schedule.friday_workout);
        if (!schedule.is_complete_saturday) notCompletes.add(schedule.saturday_workout);
      });
    ...
    totalDistance(schedule) {
      let totalDistance = 0;
      schedule.forEach(function (schedule) {
        if (schedule.sunday) totalDistance += parseFloat(schedule.sunday_distance);
        if (schedule.monday) totalDistance += parseFloat(schedule.monday_distance);
        if (schedule.tuesday) totalDistance += parseFloat(schedule.tuesday_distance);
        if (schedule.wednesday) totalDistance += parseFloat(schedule.wednesday_distance);
        if (schedule.thursday) totalDistance += parseFloat(schedule.thursday_distance);
        if (schedule.friday) totalDistance += parseFloat(schedule.friday_distance);
        if (schedule.saturday) totalDistance += parseFloat(schedule.saturday_distance);
      });
